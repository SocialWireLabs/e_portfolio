...
elgg_push_breadcrumb(elgg_echo('e_portfolio:edit_page'));

$title = elgg_echo('e_portfolio:editpagepost');
$content = elgg_view("forms/e_portfolio/edit_page", array('entity' => $e_portfolio_page)); 
