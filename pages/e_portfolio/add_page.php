...
elgg_push_breadcrumb(elgg_echo('e_portfolio:add_page'));

$title = elgg_echo('e_portfolio:addpagepost');
$content = elgg_view("forms/e_portfolio/add_page", array('entity' => $e_portfolio)); 
